...
export type Cli<commands extends CommandsMap = {}, vars extends z.ZodObject<any> | undefined = undefined, env extends z.ZodObject<any> | undefined = undefined> = {
    ...
    command: {
        ...
        <const name extends string, const spec extends Openapi.OpenAPISource | undefined = undefined>(name: name, definition: {
...
export type CommandEntry = CommandDefinition<any, any, any, any> | InternalGroup | InternalFetchGateway | InternalAlias;
...
export declare const toMiddlewares: WeakMap<Cli<{}, undefined, undefined>, MiddlewareHandler[]>;
...
export declare const toMcpOptions: WeakMap<Cli<{}, undefined, undefined>, {
    agents?: string[] | undefined;
    command?: string | undefined;
}>;
/** @internal Maps CLI instances to skill sync options. */
export declare const toSyncOptions: WeakMap<Cli<{}, undefined, undefined>, {
    cwd?: string | undefined;
    depth?: number | undefined;
    include?: string[] | undefined;
    suggestions?: string[] | undefined;
...
export declare const toVersion: WeakMap<Cli<{}, undefined, undefined>, string>;
...
export declare function buildIndexManifest(commands: Map<string, CommandEntry>, prefix?: string[]): {
    version: string;
    commands: {
        name: string;
        description?: string | undefined;
...
export declare function buildManifest(commands: Map<string, CommandEntry>, prefix?: string[]): {
    version: string;
    commands: {
        name: string;
        description?: string | undefined;
...
export declare function collectSkillCommands(commands: Map<string, CommandEntry>, prefix: string[], groups: Map<string, string>, rootCommand?: SkillCommandSource | undefined): Skill.CommandInfo[];
type SkillCommandSource = Pick<CommandDefinition<any, any, any, any, any, any>, 'args' | 'description' | 'env' | 'examples' | 'hint' | 'options' | 'output'>;
...
export declare function buildCommandSchema(command: Pick<CommandDefinition<any, any, any, any, any, any>, 'args' | 'env' | 'options' | 'output'>): {
    args?: Record<string, unknown> | undefined;
...
export type Example<args extends z.ZodObject<any> | undefined, options extends z.ZodObject<any> | undefined> = {
...
export type Usage<args extends z.ZodObject<any> | undefined, options extends z.ZodObject<any> | undefined> = {
...
export type CommandDefinition<args extends z.ZodObject<any> | undefined = undefined, env extends z.ZodObject<any> | undefined = undefined, options extends z.ZodObject<any> | undefined = undefined, output extends z.ZodType | undefined = undefined, vars extends z.ZodObject<any> | undefined = undefined, cliEnv extends z.ZodObject<any> | undefined = undefined> = CommandMeta<options> & {
